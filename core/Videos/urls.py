...
urlpatterns = [
    ...
    path("home/<https://www.youtube.com/watch?v=BgIgKcqPd4k&t=43s>", views.home, name="home"),
    path("home/<https://www.youtube.com/watch?v=1zrtBqZeylo>", views.home, name="home"),
