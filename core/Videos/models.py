...
class Channel(models.Model):
    ...
    subscribers =   models.ManyToManyField('auth.User', related_name='channel_subscribers', blank=True)
    videos =        models.ManyToManyField('Video', related_name='channel_videos', blank=True)
    subscriptions =  models.ManyToManyField('Channel', related_name='channel_subscriptions', blank=True)
